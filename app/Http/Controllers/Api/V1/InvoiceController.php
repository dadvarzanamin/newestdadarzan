...
class InvoiceController extends Controller
{
    ...
    public function order()
    {
        $orders = Invoice::query()
            ...
            ->select('invoices.id','invoices.product_type','invoices.final_price as price','products.id', 'products.title', 'products.item1', 'products.product_use', 'products.start_date as date', 'products.cover','products.file_path')
            ->where('invoices.price_status', 4)
            ->where('invoices.user_id', Auth::id())
            ->get();
