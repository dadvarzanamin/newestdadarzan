            ...
            return Datatables::of($data)
                ...
                ->editColumn('action', function ($data) {
                    ...
                    if (Gate::allows('can-access', ['paneluser', 'edit'])) {
                        $actionBtn .= '<button type="button" class="'.$base.' btn btn-sm btn-outline-primary edit-btn" data-id="'.$data->id.'" data-url="'.route('paneluser.edit', $data->id).'"><i class="mdi mdi-pencil-outline"></i></button>';
                    }
