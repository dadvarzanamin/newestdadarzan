                ...
                <div class="col-lg-8">
                    <div class="footer-widget__content ps-xl-5">
                        <div class="footer-widget__item">
                            ...
                            {{--                            </ul>--}}
                            <ul class="useful-list">
                                <li><a href="#">نظریه شورای حقوقی</a></li>
                                <li><a href="#">ایرانیان خارج از کشور</a></li>
                                <li><a href="#">تنظیم قرارداد</a></li>
                                <li><a href="#">تنظیم اوراق قضایی</a></li>
                                <li><a href="#">مشاوره</a></li>
                                <li><a href="#">ثبت شرکت</a></li>
                                <li><a href="#">قبول دعاوی</a></li>
                            </ul>
                        </div>
