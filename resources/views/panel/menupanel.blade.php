            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                @if(Gate::allows('can-access', ['menupanel', 'insert']))
                    <a href="#" class="btn btn-primary" data-bs-toggle="modal"
                       data-bs-target="#addModal">{{$thispage['add']}}</a>
                @endif
            </div>
                    ...
                    <form id="addform" data-type="create" method="POST" class="row g-4 mb-4" action="{{ route('menupanel.store') }}">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <div class="invalid-feedback" id="labelFeedback">نام منو داشبورد فارسی اجباری می باشد.
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <div class="invalid-feedback" id="controllerFeedback">کنترلر داشبورد اجباری می باشد.
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
