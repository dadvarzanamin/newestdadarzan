                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input required type="text" class="form-control" id="label" name="label"
                                       placeholder="نام  منو  فارسی" >
                                <label for="label">نام  منو  فارسی</label>
                                <div class="invalid-feedback" id="labelFeedback">نام  منو  فارسی اجباری می باشد.</div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <div class="invalid-feedback" id="titleFeedback">نام  منو اجباری می باشد.</div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <label for="submenu">زیر  منو </label>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                ...
                                <div class="invalid-feedback" id="classFeedback">کلاس  اجباری می باشد.</div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
                                <input required type="text" class="form-control" id="controller" name="controller"
                                       placeholder="کنترلر " >
                                <label for="controller">کنترلر </label>
                                <div class="invalid-feedback" id="controllerFeedback">کنترلر  اجباری می باشد.</div>
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-floating form-floating-outline">
