                    ...
                    <form id="addform" data-type="create" method="POST" action="{{ route(request()->segment(2).'.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="birthday" data-jdp id="birthday" autocomplete="off" class="form-control" placeholder="تاریخ تولد را وارد کنید">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-4">
        ...
        $(function () {
            var table = $('.yajra-datatable').DataTable({
                ...
                columns: [
                    ...
                    {data: 'phone'          , name: 'title',  className:'text-center'     },
